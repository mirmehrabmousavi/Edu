                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" aria-labelledby="account-pill-general" aria-expanded="true">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="title"
                                                                       id="account-username" placeholder="عنوان دوره" value=""
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="slug"
                                                                       id="account-username" placeholder="slug دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <textarea class="form-control" id="editor" rows="3" name="desc"
                                                                  ...
                                                                  required="" data-validation-required-message=""></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" name="b_desc"
                                                               id="account-username" placeholder="خلاصه توضیحات دوره" value=""
                                                               required="" data-validation-required-message="">
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="price"
                                                                       id="account-username" placeholder="قیمت دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="price_off"
                                                                       id="account-username" placeholder="قیمت تخفیف خورده" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="seo_title"
                                                                       id="account-username" placeholder="عنوان سئو" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="seo_desc"
                                                                       id="account-username" placeholder="توضیحات سئو" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="file" class="form-control" name="c_poster"
                                                                       id="account-username" placeholder="پوستر دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <label for="account-username">فایل دوره (اختیاری)</label>
                                                                <input type="file" class="form-control" name="c_file"
                                                                       id="account-username" placeholder="فایل دوره (اختیاری)" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="file" class="form-control" name="c_demo"
                                                                       id="account-username" placeholder="دمو دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="file" class="form-control" name="c_slider_img"
                                                                       id="account-username" placeholder="اسلایدر دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="file" class="form-control" name="c_alt_img"
                                                                       id="account-username" placeholder="تصویر شاخص دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="time"
                                                                       id="account-username" placeholder="زمان دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="status"
                                                                       id="account-username" placeholder="وضعیت دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="status_upload"
                                                                       id="account-username" placeholder="وضعیت انتشار دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" name="status"
                                                                       id="account-username" placeholder="دسته بندی دوره" value=""
                                                                       required="" data-validation-required-message="">
                                                            </div>
                                                        </div>
                                                    </div>
