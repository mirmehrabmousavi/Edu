<div class="col-lg-3 col-md-3">
    <div class="dashboard-navbar">
        ...
        <div class="d-user-avater">
            <img src="{{(!empty(auth()->user()->profile)) ? url('upload/admin/settings/'.auth()->user()->profile) : url('upload/no-profile.jpg')}}" class="img-fluid avater" alt="">
        ...
        <div class="d-navigation">
            <ul id="side-menu">
                @if(auth()->user()->is_seller == 1 || auth()->user()->is_admin === 1)
                    ...
                    <li><a href="{{route('purchasedCourse')}}"><i class="ti-heart"></i>دوره های خریده شده</a></li>
